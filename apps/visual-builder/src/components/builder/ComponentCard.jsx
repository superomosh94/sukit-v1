...
import { Star, Eye, MoreVertical, Trash2, Copy, Layout, Type, Image, FormInput, Table, Menu, ShoppingBag, Package } from 'lucide-react';
  ...
  if (viewMode === 'grid') {
    return (
      <CardContainer>
        ...
        {/* Simple dropdown menu – could be expanded later */}
        {showMenu && (
