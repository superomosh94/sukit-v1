...
import type { Animation } from "@/lib/builder/types";
    ...
    <div className="space-y-3">
      ...
      <SettingsSection title="Timing">
        ...
        <div className="flex items-center justify-between text-[10px] text-muted-foreground">
          <span>0</span>
          <span>
            {animation.type !== "none" ? (animation.duration + animation.delay) / 1000 : 0}s
          </span>
        </div>
      </SettingsSection>
      ...
      <SettingsSection title="Cascade">
        ...
        <SettingsField label={`Stagger Delay: ${animation.cascadeLevel * 100}ms`}>
