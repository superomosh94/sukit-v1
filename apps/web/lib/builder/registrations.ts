...
import BackToTopBlock from "@/components/blocks/BackToTopBlock";
import CardBlock from "@/components/blocks/CardBlock";
import GalleryBlock from "@/components/blocks/GalleryBlock";
import AvatarBlock from "@/components/blocks/AvatarBlock";
import TableBlock from "@/components/blocks/TableBlock";

function s(label: string, type: BlockPropSchema["type"] = "string", extra: Partial<BlockPropSchema> = {}): BlockPropSchema {
...
const registrations: BlockRegistration[] = [
  // ── Layout Blocks ──
  {
    ...
    icon: "⊞",
    schema: {
      maxWidth: s("Max Width", "string", { default: "1200px", group: "layout" }),
    ...
    defaultAnimation: { type: "fadeIn", duration: 500, delay: 0, easing: "ease-out", cascadeLevel: "block" },
  ...
  },
  {
    ...
    schema: {
      ...
      paddingBottom: s("Padding Bottom", "number", { default: 60, group: "spacing" }),
      maxWidth: s("Inner Max Width", "string", { default: "1200px", group: "layout" }),
    },
  ...
  },
  {
    ...
    schema: {
      ...
      alignItems: s("Align Items", "select", { default: "stretch", options: [{ label: "Stretch", value: "stretch" }, { label: "Start", value: "flex-start" }, { label: "Center", value: "center" }, { label: "End", value: "flex-end" }], group: "layout" }),
      justifyContent: s("Justify Content", "select", { default: "flex-start", options: [{ label: "Start", value: "flex-start" }, { label: "Center", value: "center" }, { label: "End", value: "flex-end" }, { label: "Space Between", value: "space-between" }, { label: "Space Around", value: "space-around" }], group: "layout" }),
    },
    defaultProps: { gap: "16px", alignItems: "stretch", justifyContent: "flex-start" },
    defaultStyles: {},
    Component: RowBlock,
  },
  {
  ...
  },
  {
    ...
    icon: "⫶",
    schema: {
      direction: s("Direction", "select", { default: "vertical", options: [{ label: "Vertical", value: "vertical" }, { label: "Horizontal", value: "horizontal" }], group: "layout" }),
  ...
  },
  {
    ...
    icon: "―",
    schema: {
      style: s("Line Style", "select", { default: "solid", options: [{ label: "Solid", value: "solid" }, { label: "Dashed", value: "dashed" }, { label: "Dotted", value: "dotted" }] }),
      color: s("Color", "color", { default: "#d1d5db" }),
      thickness: s("Thickness", "string", { default: "1px" }),
      width: s("Width", "string", { default: "100%" }),
    },
    defaultProps: { style: "solid", color: "#d1d5db", thickness: "1px", width: "100%" },
    defaultStyles: {},
  ...
  // ── Typography Blocks ──
  {
    ...
    schema: {
      ...
      level: s("Level", "select", { default: "h2", options: [{ label: "H1", value: "h1" }, { label: "H2", value: "h2" }, { label: "H3", value: "h3" }, { label: "H4", value: "h4" }, { label: "H5", value: "h5" }, { label: "H6", value: "h6" }] }),
      textAlign: s("Align", "select", { default: "left", options: [{ label: "Left", value: "left" }, { label: "Center", value: "center" }, { label: "Right", value: "right" }] }),
    },
  ...
  },
  {
    ...
    icon: "¶",
    schema: {
      text: s("Text", "rich-text", { default: "Add some descriptive text here." }),
      textAlign: s("Align", "select", { default: "left", options: [{ label: "Left", value: "left" }, { label: "Center", value: "center" }, { label: "Right", value: "right" }, { label: "Justify", value: "justify" }] }),
      dropCap: s("Drop Cap", "boolean", { default: false }),
    },
    defaultProps: { text: "Add some descriptive text here.", textAlign: "left", dropCap: false },
  ...
  },
  {
    ...
    icon: "≡",
    schema: {
      type: s("List Type", "select", { default: "bullet", options: [{ label: "Bullet", value: "bullet" }, { label: "Numbered", value: "numbered" }] }),
  ...
  },
  {
    ...
    icon: "❝",
    schema: {
      text: s("Quote Text", "rich-text", { default: "The best way to predict the future is to create it." }),
      author: s("Author", "string", { default: "Peter Drucker" }),
    },
    defaultProps: { text: "The best way to predict the future is to create it.", author: "Peter Drucker" },
  ...
  },
  {
    ...
    schema: {
      ...
      language: s("Language", "select", { default: "javascript", options: [{ label: "JavaScript", value: "javascript" }, { label: "TypeScript", value: "typescript" }, { label: "HTML", value: "html" }, { label: "CSS", value: "css" }, { label: "Python", value: "python" }, { label: "JSON", value: "json" }, { label: "Shell", value: "bash" }] }),
    },
    defaultProps: { code: "console.log('hello world');", language: "javascript" },
    defaultStyles: { backgroundColor: "#1e293b", color: "#e2e8f0", borderRadius: 8 },
    Component: CodeBlock,
  },
  ...
  },
  {
    ...
    schema: {
      ...
      type: s("Source Type", "select", { default: "mp4", options: [{ label: "MP4", value: "mp4" }, { label: "YouTube", value: "youtube" }, { label: "Vimeo", value: "vimeo" }] }),
  ...
  },
  {
    ...
    defaultProps: { iconName: "Star", size: 24, color: "currentColor", strokeWidth: 2 },
    defaultStyles: {},
    Component: IconBlock,
  },
  {
  ...
  },
  {
    ...
    icon: "🗺",
    schema: {
      address: s("Address", "string", { default: "1600 Amphitheatre Parkway, Mountain View, CA" }),
      zoom: s("Zoom Level", "number", { default: 14 }),
      height: s("Height", "string", { default: "400px" }),
    },
    defaultProps: { address: "1600 Amphitheatre Parkway, Mountain View, CA", zoom: 14, height: "400px" },
    defaultStyles: {},
    Component: MapBlock,
  },
  ...
  // ── Data Blocks ──
  {
    ...
    icon: "≡",
    schema: {
      items: s("Items", "array", { default: [{ title: "Section 1", content: "Content here..." }] }),
      allowMultiple: s("Allow Multiple Open", "boolean", { default: false }),
    },
    defaultProps: { items: [{ title: "Section 1", content: "Content here..." }], allowMultiple: false },
    defaultStyles: {},
  ...
  },
  {
    ...
    icon: "▦",
    schema: {
      tabs: s("Tabs", "array", { default: [{ label: "Tab 1", content: "Content 1" }, { label: "Tab 2", content: "Content 2" }] }),
      defaultTab: s("Default Tab", "number", { default: 0 }),
    },
    defaultProps: { tabs: [{ label: "Tab 1", content: "Content 1" }, { label: "Tab 2", content: "Content 2" }], defaultTab: 0 },
    defaultStyles: {},
    Component: TabsBlock,
  },
  {
    ...
    defaultProps: { images: [], interval: 5000, showDots: true, showArrows: true },
    defaultStyles: {},
  ...
  },
  {
    ...
    schema: {
      ...
      description: s("Description", "rich-text", { default: "Card description goes here." }),
  ...
  },
  {
    ...
    icon: "⊞",
    schema: {
      headers: s("Headers", "array", { default: ["Column 1", "Column 2", "Column 3"] }),
      rows: s("Rows", "array", { default: [["Row 1", "Data", "Data"], ["Row 2", "Data", "Data"]] }),
    },
    defaultProps: { headers: ["Column 1", "Column 2", "Column 3"], rows: [["Row 1", "Data", "Data"], ["Row 2", "Data", "Data"]] },
    defaultStyles: {},
  ...
  // ── Navigation Blocks ──
  {
    ...
    icon: "☰",
    schema: {
      items: s("Menu Items", "array", { default: [{ label: "Home", url: "/" }, { label: "About", url: "/about" }, { label: "Contact", url: "/contact" }] }),
      alignment: s("Alignment", "select", { default: "left", options: [{ label: "Left", value: "left" }, { label: "Center", value: "center" }, { label: "Right", value: "right" }] }),
    },
    defaultProps: { items: [{ label: "Home", url: "/" }, { label: "About", url: "/about" }, { label: "Contact", url: "/contact" }], alignment: "left" },
    defaultStyles: {},
    Component: MenuBlock,
  },
  {
    ...
    icon: "›",
    schema: {
      items: s("Items", "array", { default: [{ label: "Home", url: "/" }, { label: "Current Page", url: "" }] }),
      separator: s("Separator", "string", { default: "/" }),
    },
    defaultProps: { items: [{ label: "Home", url: "/" }, { label: "Current Page", url: "" }], separator: "/" },
  ...
  },
  {
    ...
    schema: {
      ...
      position: s("Position", "select", { default: "bottom-right", options: [{ label: "Bottom Right", value: "bottom-right" }, { label: "Bottom Left", value: "bottom-left" }] }),
    },
  ...
  // ── Interactive Blocks ──
  {
    ...
    icon: "☐",
    schema: {
      fields: s("Fields", "array", { default: [{ type: "text", label: "Name", required: true }, { type: "email", label: "Email", required: true }, { type: "textarea", label: "Message" }] }),
      submitText: s("Submit Button Text", "string", { default: "Submit" }),
    },
    defaultProps: { fields: [{ type: "text", label: "Name", required: true }, { type: "email", label: "Email", required: true }, { type: "textarea", label: "Message" }], submitText: "Submit" },
    defaultStyles: {},
    Component: FormBlock,
  },
  {
    ...
    schema: {
      ...
      variant: s("Variant", "select", { default: "primary", options: [{ label: "Primary", value: "primary" }, { label: "Secondary", value: "secondary" }, { label: "Outline", value: "outline" }, { label: "Ghost", value: "ghost" }] }),
      size: s("Size", "select", { default: "md", options: [{ label: "Small", value: "sm" }, { label: "Medium", value: "md" }, { label: "Large", value: "lg" }] }),
    },
    defaultProps: { text: "Button", variant: "primary", size: "md" },
    defaultStyles: { borderRadius: 6 },
    defaultAnimation: { type: "fadeIn", duration: 300, delay: 0, easing: "ease-out", cascadeLevel: "block" },
  ...
  // ── Existing Blocks (Testimonial, Pricing, FAQ) ──
  {
    ...
    defaultProps: { quote: "Great product!", author: "Jane Doe", role: "CEO, Company" },
  ...
  },
  {
    ...
    schema: {
      ...
      features: s("Features", "array", { default: ["Feature 1", "Feature 2", "Feature 3"] }),
      ctaText: s("CTA Text", "string", { default: "Get Started" }),
      highlighted: s("Highlighted", "boolean", { default: false }),
    },
    defaultProps: { plan: "Professional", price: "$29", period: "/month", features: ["Feature 1", "Feature 2", "Feature 3"], ctaText: "Get Started", highlighted: false },
  ...
  },
  {
    ...
    icon: "?",
    schema: {
      items: s("Questions", "array", { default: [{ question: "What is this?", answer: "This is a FAQ item." }] }),
    },
    defaultProps: { items: [{ question: "What is this?", answer: "This is a FAQ item." }] },
    defaultStyles: {},
    Component: FAQBlock,
  },
];
