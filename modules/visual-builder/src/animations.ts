...
export const ENTER_ANIMATION_PRESETS: Record<
  EnterAnimationType,
  {
    keyframes: string;
    css: string;
...
> = {
  fadeIn: {
    keyframes:
      '@keyframes builder-fadeIn { from { opacity: 0; } to { opacity: 1; } }',
  ...
  slideUp: {
    keyframes:
      '@keyframes builder-slideUp { from { opacity: 0; transform: translateY(30px); } to { opacity: 1; transform: translateY(0); } }',
  ...
  slideLeft: {
    keyframes:
      '@keyframes builder-slideLeft { from { opacity: 0; transform: translateX(30px); } to { opacity: 1; transform: translateX(0); } }',
  ...
  slideRight: {
    keyframes:
      '@keyframes builder-slideRight { from { opacity: 0; transform: translateX(-30px); } to { opacity: 1; transform: translateX(0); } }',
  ...
  scaleIn: {
    keyframes:
      '@keyframes builder-scaleIn { from { opacity: 0; transform: scale(0.9); } to { opacity: 1; transform: scale(1); } }',
  ...
  rotateIn: {
    keyframes:
      '@keyframes builder-rotateIn { from { opacity: 0; transform: rotate(-10deg) scale(0.8); } to { opacity: 1; transform: rotate(0deg) scale(1); } }',
  ...
  flipIn: {
    keyframes:
      '@keyframes builder-flipIn { from { opacity: 0; transform: perspective(400px) rotateX(-90deg); } to { opacity: 1; transform: perspective(400px) rotateX(0deg); } }',
  ...
  typewriter: {
    keyframes:
      '@keyframes builder-typewriter { from { width: 0; } to { width: 100%; } }',
